...
export function SearchModal({ isSearchModalOpen, toggleSearchModal }: SearchModalProps) {
  ...
  }, [isSearchModalOpen, debouncedFetch]);
      ...
      return (
        ...
        >
          {results.map((anime) => (
            ...
            >
              <SearchCard anime={anime} onClick={toggleSearchModal} />
            </motion.div>
          ))}
        </motion.ul>
      );
