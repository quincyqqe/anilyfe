  ...
  return (
    <div ref={menuRef} className="relative">
      <button
        ...
        className="flex h-9 w-9 items-center justify-center rounded-xl text-white/70 transition duration-200 hover:bg-white/10 hover:text-white focus:outline-none active:scale-95"
